...
public class ProblemaRadioButton extends JFrame implements ActionListener{
    ...
    public static void main(String[] args) {
    	ProblemaRadioButton formulario1=new ProblemaRadioButton();
        formulario1.setBounds(0,0,350,250);
        formulario1.setVisible(true);
    } 
    
    public ProblemaRadioButton() {
        setLayout(null);
        tf1=new JTextField();
